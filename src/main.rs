...
struct AnimateTransform {
    from_transform: Option<Transform>,
...
impl Default for AnimateTransform {
    fn default() -> Self {
        Self {
            from_transform: None,
            to_transform: Transform::default(),
            duration: 0.5,
            elapsed: 0.0,
        }
    }
...
fn spawn_color_wells(
    ...
    let position = Vec3::new(0., -0.49, 0.);
            ...
            if let Ok(inactive_color_well) = inactive_color_wells.get(*grid_map_entity) {
                ...
                collector.with_children(|parent| {
                    ...
                    parent.spawn((
                        ...
                        AnimateTransform {
                            to_transform: Transform {
                                translation: Vec3::new(0.0, 0.2, laser_length + 0.5),
                                scale: Vec3::new(0.03, laser_length, 0.04),
                                ..default()
                            },
                            duration: 5.,
                            ..Default::default()
...
fn animate_transform_system(
    ...
    for (entity, mut animation, mut transform) in query.iter_mut() {
        if None == animation.from_transform {
            animation.from_transform = Some(transform.clone());
        }
        ...
        if t >= 1.0 {
            ...
            transform.translation = animation
                ...
                .unwrap()
                .translation
                .interpolate(animation.to_transform.translation, t);
            transform.scale = animation
                .from_transform
                .unwrap()
                .scale
                .interpolate(animation.to_transform.scale, t);
        }
    }
}
